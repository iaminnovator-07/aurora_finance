import { c as PageHeader, n as ConfidenceBar, o as AppLayout, s as Card, t as Badge, x as useInvoices } from "./ui-bits-nExllFl8.js";
import { useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { RefreshCw, Search } from "lucide-react";
//#region src/routes/invoices.tsx?tsr-split=component
var STATUS_FILTERS = [
	"All",
	"auto_approved",
	"in_review",
...
function Invoices() {
	...
	return /* @__PURE__ */ jsxs(AppLayout, { children: [/* @__PURE__ */ jsx(PageHeader, {
		...
		actions: /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("button", {
			onClick: () => refetch(),
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: STATUS_FILTERS.map((t) => /* @__PURE__ */ jsx("button", {
					onClick: () => setFilter(t),
			...
			children: isLoading ? /* @__PURE__ */ jsx("div", {
				...
				children: [/* @__PURE__ */ jsx("thead", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("td", {
							className: "px-5 py-3",
							children: /* @__PURE__ */ jsx(ConfidenceBar, { value: r.trust_score ?? 0 })
						}),
						/* @__PURE__ */ jsx("td", {
							className: "px-5 py-3",
