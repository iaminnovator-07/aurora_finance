import { c as PageHeader, h as useCopilotChat, i as ThinkingDots, o as AppLayout, s as Card, t as Badge } from "./ui-bits-nExllFl8.js";
import { useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { BarChart3, Download, FileText, Mic, Paperclip, Send, Sparkles } from "lucide-react";
//#region src/routes/copilot.tsx?tsr-split=component
var prompts = [
...
function Copilot() {
	...
	return /* @__PURE__ */ jsxs(AppLayout, { children: [/* @__PURE__ */ jsx(PageHeader, {
		title: "AI Copilot",
		subtitle: "Ask Aurora in natural language.",
		actions: /* @__PURE__ */ jsxs(Badge, {
			tone: "ai",
			children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3 w-3" }), " Aurora v2.3"]
		})
	}), /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs(Card, {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [messages.map((m, i) => /* @__PURE__ */ jsxs("div", {
					...
					children: [m.role === "ai" && /* @__PURE__ */ jsx("div", {
						...
						children: [/* @__PURE__ */ jsx("p", {
							...
							children: m.content
						}), m.data && Object.keys(m.data).length > 0 && /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("pre", {
								...
								children: [
									/* @__PURE__ */ jsxs("button", {
										...
										children: [/* @__PURE__ */ jsx(BarChart3, { className: "h-3 w-3" }), " Visualize"]
									}),
									/* @__PURE__ */ jsxs("button", {
										className: "text-xs px-3 py-1.5 rounded-lg border border-border inline-flex items-center gap-1",
										children: [/* @__PURE__ */ jsx(Download, { className: "h-3 w-3" }), " Export CSV"]
									}),
									/* @__PURE__ */ jsx("button", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: ["Aurora is thinking ", /* @__PURE__ */ jsx(ThinkingDots, {})]
					})]
				})]
			}), /* @__PURE__ */ jsx("div", {
			...
			className: "space-y-4",
			children: [/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx("h3", {
				...
				children: [messages.filter((m) => m.role === "user").slice(-3).reverse().map((r, i) => /* @__PURE__ */ jsxs("button", {
				...
				}, i)), messages.filter((m) => m.role === "user").length === 0 && /* @__PURE__ */ jsx("div", {
