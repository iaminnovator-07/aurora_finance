import { a as TrustRing, c as PageHeader, m as useClients, o as AppLayout, s as Card, t as Badge } from "./ui-bits-nExllFl8.js";
import { jsx, jsxs } from "react/jsx-runtime";
import { Activity, ExternalLink, FileText, Mail, MapPin, Percent, Phone, ShieldCheck } from "lucide-react";
...
function Clients() {
	...
	return /* @__PURE__ */ jsxs(AppLayout, { children: [
		...
		isLoading && /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("div", { className: "h-48 rounded-xl bg-slate-900 animate-pulse" }), /* @__PURE__ */ jsx("div", { className: "h-64 rounded-xl bg-slate-900 animate-pulse" })]
		}),
		featured && /* @__PURE__ */ jsxs(Card, {
			className: "mb-6 grid lg:grid-cols-[auto_1fr_auto] gap-6 items-center bg-slate-900 border-slate-800",
			children: [
				/* @__PURE__ */ jsx(TrustRing, {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: [
								...
								featured.trust_score >= 80 && /* @__PURE__ */ jsxs(Badge, {
									tone: "success",
									className: "gap-1",
									children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-3 w-3" }), " Trusted"]
								})
							]
						}), /* @__PURE__ */ jsxs("div", {
							className: "mt-1 flex gap-4 text-xs text-muted-foreground",
							children: [/* @__PURE__ */ jsxs("span", { children: ["GST: ", /* @__PURE__ */ jsx("span", {
								className: "font-medium text-foreground",
								children: featured.gst
							})] }), /* @__PURE__ */ jsxs("span", { children: ["PAN: ", /* @__PURE__ */ jsx("span", {
								className: "font-medium text-foreground",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(FileText, { className: "h-3 w-3" }), " Invoices"]
							}), /* @__PURE__ */ jsx("div", {
							...
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
								className: "text-muted-foreground text-[10px] uppercase tracking-wider flex items-center gap-1",
								children: [/* @__PURE__ */ jsx(Activity, { className: "h-3 w-3" }), " Spend YTD"]
							}), /* @__PURE__ */ jsx("div", {
								className: "font-bold text-lg mt-0.5",
							...
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
								className: "text-muted-foreground text-[10px] uppercase tracking-wider flex items-center gap-1",
								children: [/* @__PURE__ */ jsx(Percent, { className: "h-3 w-3" }), " Approval Rate"]
							}), /* @__PURE__ */ jsxs("div", {
								className: "font-bold text-lg mt-0.5",
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", { children: "Trust trend (12mo)" }), /* @__PURE__ */ jsx("span", {
		...
		!isLoading && clients.length === 0 && /* @__PURE__ */ jsx(Card, {
		...
		!isLoading && clients.length > 0 && /* @__PURE__ */ jsxs(Card, {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					children: [/* @__PURE__ */ jsx("thead", {
						...
						children: clients.map((c) => /* @__PURE__ */ jsxs("tr", {
