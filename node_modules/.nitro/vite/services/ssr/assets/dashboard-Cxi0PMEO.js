import { a as TrustRing, g as useDashboard, i as ThinkingDots, l as useAgentsStatus, n as ConfidenceBar, o as AppLayout, r as StatCard, s as Card, t as Badge } from "./ui-bits-nExllFl8.js";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowUpRight, Bot, Brain, Building2, CheckCircle2, Clock, FileText, Mail, RefreshCw, ScanLine, Shield, ShieldAlert, Sparkles, TrendingUp, Zap } from "lucide-react";
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Link, {
							...
							children: ["Review Queue ", /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4" })]
						}), /* @__PURE__ */ jsx(Link, {
							to: "/copilot",
					...
					children: [/* @__PURE__ */ jsx(TrustRing, {
			...
			children: [/* @__PURE__ */ jsxs(Card, {
				...
				/* @__PURE__ */ jsx(ResponsiveContainer, {
					...
					children: /* @__PURE__ */ jsx(PieChart, { children: /* @__PURE__ */ jsx(Pie, {
						...
						paddingAngle: 3,
						stroke: "none",
						children: approval.map((e, i) => /* @__PURE__ */ jsx(Cell, { fill: e.color ?? "var(--primary)" }, i))
					}) })
				}),
				/* @__PURE__ */ jsx("div", {
					className: "space-y-1.5 mt-2",
					children: approval.map((a) => /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs(Card, { children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [dash?.touchless_percentage?.toFixed(0) ?? "—", /* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(TrendingUp, { className: "h-3 w-3" }), " Live automation rate"]
					})
				] })
			]
		}),
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(Card, {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [recent.length === 0 && /* @__PURE__ */ jsx("div", {
						className: "px-5 py-8 text-center text-sm text-muted-foreground",
						children: "No invoices yet — sync inbox to start processing."
					}), recent.map((r) => /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("span", { children: r.id }), /* @__PURE__ */ jsx(Badge, {
							...
							/* @__PURE__ */ jsx("div", {
								className: "w-24",
								children: /* @__PURE__ */ jsx(ConfidenceBar, { value: r.trust })
							}),
							/* @__PURE__ */ jsx("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsx(AGENT_ICONS[a.name] ?? Bot, { className: "h-4 w-4" })
								}),
								/* @__PURE__ */ jsxs("div", {
								...
								a.status === "thinking" ? /* @__PURE__ */ jsx(ThinkingDots, {}) : /* @__PURE__ */ jsx("span", { className: `h-2 w-2 rounded-full ${a.status === "active" ? "bg-success" : "bg-muted-foreground/40"}` })
							]
						}), /* @__PURE__ */ jsx("div", {
							className: "mt-2",
							children: /* @__PURE__ */ jsx(ConfidenceBar, { value: a.conf })
						})]
					}, a.name);
				})
			})] })]
